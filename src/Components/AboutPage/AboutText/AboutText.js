...
const AboutText = () => {
  ...
  const handleChange = (event) => {
    ...
    if (name === "education" && !className.includes("active")) {
      setBtnClass1(true);
      setBtnClass2(false);
    } else if (name === "experience" && !className.includes("active")) {
      setBtnClass1(false);
      setBtnClass2(true);
    }
    setAboutTab(name);
    ...
    <div className="about-text col-lg-8 col-md-12 my-3">
      ...
      <div className="about-tab">
        <button
          ...
          name="education"
          type="button"
          className={btnClass1 ? "tab-item active" : "tab-item"}
        >
          education
        </button>
        <button
          ...
          name="experience"
          type="button"
          className={btnClass2 ? "tab-item active" : "tab-item"}
        >
          experience
        </button>
      </div>

      {aboutTab === "education" ? <Education /> : <Experience />}

      <a href="images/resume/MyITresume.pdf" className="btn" download="Resume">
        Download CV
      </a>
